...
% %================================================================================
% Bands(j).Models(1).parameter(3)
% (char(string('j')+string(3))
% j3=545
% eval(genvarname(char(string('j')+string(3))))
% eval([(char(string('j')+string(3)))  '=I1'])
% 
% 
% 
% for i=1:3
% genvarname('A',  num2str(555));
% eval(['A' num2str(555) '= j'])
